<#This script will create the iso file. Just adjust the variables
the script has been found on http://thelowercasew.com/create-an-iso-file-with-powershell

0. variables#>

$today = get-date -Format "yyyyMMdd"
$source_dir = "A:\Voice\Platforms\AudioCodes\EO\Hyper-V\Powershell Scripts"
$destination_file = "A:\Voice\Platforms\AudioCodes\EO\Hyper-V\EO_Hyper-V_$($today).iso"
...
#2.Create the ISOFile
get-childitem "$source_dir" | New-ISOFile -path "$destination_file"
